...
def init_database():
    with app.app_context():
        ...
        l1 = LostItem(title="黑色联想充电器", desc="图书馆三楼", location="图书馆", type=1, user_id=u1.id,
                      image="https://picsum.photos/200/200?1")
        l2 = LostItem(title="校园卡丢了", desc="卡号2021001", location="二食堂", type=0, user_id=u2.id,
                      image="https://picsum.photos/200/200?2")


        s1 = Skill(title="Python 辅导", desc="擅长爬虫、Web开发，可以辅导期末大作业", cost="10积分", type=1,
                   user_id=u3.id, image="https://picsum.photos/200/200?3")
        s2 = Skill(title="求帮取快递", desc="快递在南门菜鸟驿站，大概5kg", cost="2积分", type=2, user_id=u2.id,
